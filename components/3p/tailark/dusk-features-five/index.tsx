...
import { Activity, ArrowRightLeft, ArrowUp, Bell, Calendar, ChevronDown, Clock, CloudDownload, HardDriveDownload, History, Link2, ListChecks, Mail, Mic2, MonitorDown, Plug, Plus, Users, Zap } from 'lucide-react'
...
const featureHighlights: Record<FeatureId, { icon: ComponentType<{ className?: string }>; label: string }[]> = {
    'workflow-agents': [
...
function FeatureList({ items }: { items: { icon: ComponentType<{ className?: string }>; label: string }[] }) {
    return (
