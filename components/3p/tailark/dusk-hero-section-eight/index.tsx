...
import { Google } from '@/components/3p/tailark/_shared/core__ui__svgs__google'
import { Trustpilot } from '@/components/3p/tailark/_shared/core__ui__svgs__trustpilot'
import { G2 } from '@/components/3p/tailark/_shared/core__ui__svgs__g2'
