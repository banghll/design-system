/* 테마 프리셋 — tweakcn(https://github.com/jnsahaj/tweakcn) 에서 가져왔다.
 * Apache License 2.0.
 * 키가 우리 CSS 변수와 1:1 로 맞아 그대로 :root 에 꽂을 수 있다.
 * 프리셋을 바꾸면 컴포넌트·블록·패턴이 한 번에 따라온다. */
  ...
  "tweakcn-dm-sans": {
    ...
    styles: {
      ...
      dark: {
        ...
        "primary": "oklch(0.5160 0.2025 281.8792)",
